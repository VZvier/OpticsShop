                ...
                .authorizeHttpRequests((request) ->
                        request
                                ...
                                .requestMatchers(HttpMethod.GET, "/shop/api/users/auth-customer/info",
                                        ...
                                        "/shop/api/users/full/by-id/*", "/shop/api/users/page/**",
                                        "/shop/api/users/address/page", "/shop/api/users/address",
                                        "/shop/orders/all", "/shop/orders/page/", "/shop/orders/page/*",
                                        "/shop/orders/customer/*", "/shop/orders/by-user-id/*", "/shop/orders/by-id/*",
